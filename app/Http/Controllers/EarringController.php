...
class EarringController extends Controller
{
    ...
    public function dataop()
    {
        $data = DB::connection('MAX')
            ...
            ->where('EstadoOP', '<', 4)
            ->get();
        return Inertia::render('Applications/Earrings/Dataop', [
            'op' => $data]);
    ...
    public function ovopen()
    {
        ...
        return Inertia::render('Applications/Earrings/OvOpen', [
            'ov' => $data]);
    ...
    public function dataov()
    {
        ...
        return Inertia::render('Applications/Earrings/Dateov', [
            'op' => $data]);
    ...
    public function hot()
    {
        ...
        return Inertia::render('Applications/Earrings/Hot', [
            'op' => $data,
            'ov' => $OV]);
    ...
    public function summary()
    {
        ...
        return Inertia::render('Applications/Earrings/Summary', [
            'OV' => $OV,
            'op' => $result]);
    }
    ...
    public function samples()
    {
        ...
        return Inertia::render('Applications/Earrings/Samples', [
            'OV' => $finalTable
        ]);
    }
}
