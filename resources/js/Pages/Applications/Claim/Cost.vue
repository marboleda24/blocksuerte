<template>
    <div>
        <Head title="Gestión reclamos costos"/>

        <portal to="application-title">
            Gestión reclamos costos
        </portal>
        ...
        store(hash){
            this.$swal({
                ...
                inputValidator: (inputValue) => {
                    return !inputValue && 'El comentario es obligatorio'
                }
            }).then((inputValue) => {
                if (inputValue.value) {
                    this.$swal({
                    ...
                    axios.post(route('claim.cost-store', hash), {
        ...
        refuse(hash) {
            this.$swal({
                ...
                if (inputValue.value) {
                    ...
                    axios.post(route('claim.cost-refuse', hash), {
                        justify: inputValue.value
                    }).then(res => {
                        this.table.data = res.data;
