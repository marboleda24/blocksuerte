<template>
    <div>
        <Head title="Notas Crédito Exportación"/>

        <portal to="application-title">
            Notas Crédito Exportación
        </portal>
...
export default {
    ...
    methods: {
        get_invoices() {
            ...
            axios.get(route('electronic_billing.exports.credit-notes.search-by-date', this.entity), {
                params: {
        ...
        web_service(invoices) {
            if (invoices.length > 0) {
                ...
                axios.post(route('electronic_billing.exports.credit-notes.send-local-api', this.entity), {
                    documents: invoices,
                    date: this.date_range
                }).then(resp => {
