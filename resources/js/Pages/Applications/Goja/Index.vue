    ...
    methods: {
        ...
        getEmployees(year, month, start_period, end_period) {
            ...
            if (this.v$.form.$invalid) {
                ...
                this.$refs.table_payroll.$refs.table.resetSelectedRows();
                this.table.data = []
                axios.get(route('goja.payroll.get-employees'), {
                    params: {
                        year: year,
                        month: month,
        ...
        generatePayroll(data) {
            ...
            if (this.v$.$invalid || this.selected.length === 0) {
                ...
                axios.post(route('goja.payroll.send-api'), data).then(resp => {
                    this.$swal({
                        icon: 'success',
                    ...
                    this.$refs.table_payroll.$refs.table.resetSelectedRows();
                    this.freshData(this.form.year, this.form.month, this.form.start_period, this.form.end_period)
