<template>
    <div>
        <Head title="Pedidos Pendientes (Troqueles)"/>

        <portal to="application-title">
            Pedidos Pendientes (Troqueles)
        </portal>
...
export default{
    ...
    methods: {
        finalize(row) {
            if (row.type === 'national' || row.type === 'export' || row.type === 'samples') {
                this.$swal({
                    ...
                    input: 'select',
                    inputOptions: {
                        '01': 'Troquel alquilado',
                        '02': 'Troquel cambio',
                        '03': 'Troquel cobrado en M/CI',
                        '04': 'Troquel obsequiado',
                        '05': 'Troqueles punto de venta',
                        '06': 'Troquel prestado',
                        '08': 'Troquel vendido'
                    },
                    ...
                    if (inputValue.value) {
                        const dies_reason = inputValue.value;
        ...
        refuse(row) {
            this.$swal({
                ...
                allowEscapeKey: false,
                    ...
                    axios.post(route('orders.dies.refuse'), {
                        'id': row,
                        'justify': inputValue.value,
