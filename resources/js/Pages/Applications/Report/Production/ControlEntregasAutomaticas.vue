<template>
    <div>
        <Head title="Produccion - Control entregas automaticas" />

        <portal to="application-title">
            Produccion - Control entregas automaticas
        </portal>

        <portal to="actions" >
            <a class="btn btn-primary" :href="route('report-production.control-entrega-automaticas-pdf', form)" target="_blank">
...
export default {
            ...
            table: {
                ...
                options: {
                    ...
                    templates: {
                        ...
                        RESPONSABLE(h, row){
                            return `${row.RESPONSABLE} | ${row.COD_RESP}`
                        }
                    },
                    cellClasses: {
                        CANT: [{
    ...
    methods: {
        downloadReport(){
            ...
            let fileName = "control-entregas-troquelado.xlsx"
            axios.post(route('download-report-production.control-entrega-automaticas'), {
        ...
        queryPending(){
            ...
            axios.get(route('report-production.get-control-entrega-automaticas'), {
                params: {
                    date_range: this.form.date_range
                }
            }).then(resp => {
