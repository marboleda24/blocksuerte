<template>
    <div>
        <Head title="Produccion - Control entregas troquelado" />

        <portal to="application-title">
            Produccion - Control entregas troquelado
        </portal>

        <portal to="actions" >
            <a class="btn btn-primary" :href="route('report-production.control-entrega-troquelado-pdf', form)" target="_blank">
...
export default {
    ...
    methods: {
        downloadReport(){
            ...
            axios.post(route('download-report-production.control-entrega-troquelado'), {
        ...
        queryPending(){
            ...
            axios.get(route('report-production.get-control-entrega-troquelado'), {
                params: {
                    date_range: this.form.date_range
                }
            }).then(resp => {
    ...
    computed: {
        ...
        total(){
            ...
            this.table.data.reduce((a, c) => a + c.CANT, 0)
