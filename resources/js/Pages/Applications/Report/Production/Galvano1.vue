<template>
    <div>
        <Head title="Reportes - Produccion - Galvano 1" />

        <portal to="application-title">
            Reportes - Produccion - Galvano 1
        </portal>
...
export default {
    ...
    methods: {
        downloadReport(){
            ...
            let fileName = "pendientes-galvano-1.xlsx"
        ...
        downloadPDF(sortBy){
            ...
            axios.get(route('report-production.galvano-1-pdf', sortBy), {
                responseType: 'blob'
            }).then(resp => {
                this.$swal({
                    icon: 'error',
