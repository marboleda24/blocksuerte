<template>
    <div>
        <Head title="Reportes - Produccion - Galvano 2" />

        <portal to="application-title">
            Reportes - Produccion - Galvano 2
        </portal>
...
export default {
    ...
    methods: {
        downloadReport(){
            ...
            let fileName = "pendientes-galvano-2.xlsx"
        ...
        downloadPDF(sortBy){
            ...
            axios.get(route('report-production.galvano-2-pdf', sortBy), {
                responseType: 'blob'
            }).then(resp => {
                this.$swal({
                    icon: 'error',
