<template>
    <div>
        <Head title="Reportes - Produccion - Inspeccion y Empaque" />

        <portal to="application-title">
            Reportes – Produccion – Inspeccion y Empaque
        </portal>
...
export default {
                    ...
                    templates: {
                        ...
                        FECHAS(h, row){
                            return <ul>
                                ...
                                <li>Inspeccion y empaque: {row.FECHA_MOV}</li>
                            </ul>
                        },
                    }
                },
    ...
    methods: {
        downloadReport(){
            ...
            let fileName = "pendientes-inspeccion-y-empaque.xlsx"
