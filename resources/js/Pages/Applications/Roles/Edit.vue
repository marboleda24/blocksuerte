<template>
    <div>
        <Head :title="`Editar ${role.description}`"/>
            ...
            <div class="p-5">
                <div class="grid grid-cols-3 gap-4">
                    <div class="mt-2">
                        ...
                        <input type="text" class="form-control" v-model="form.name" :class="{ 'border-danger': v$.form.name.$error }">
                    ...
                    <div class="mt-2">
                        ...
                        <input type="text" class="form-control" v-model="form.description" :class="{ 'border-danger': v$.form.description.$error }">
                    ...
                    <div class="mt-2">
                        ...
                        <input type="checkbox" class="form-check-input" v-model="form.protected">
                    </div>
                </div>
                <div class="mt-10">
                    <div id="group-accordion" class="accordion">
                        <div class="accordion-item" v-for="group in permissionGroups">
                ...
                <div class="flex flex-row mt-5 text-center justify-center">
                    <button class="btn btn-primary" @click="update(form)">
                        ACTUALIZAR ROL
                    </button>
                </div>
            </div>
    ...
    data(){
        return {
            form: {
                ...
                guard_name: 'sanctum',
                permissions: this.rolePermissions.map(function (x){
                    return x.id
                }),
            }
        }
    ...
    methods: {
        update(data){
            ...
            if (this.v$.$invalid) {
                ...
                axios.put(route('roles.update', data.id), data).then(resp => {
                    this.$swal({
                        title: '¡Éxito!',
