<template>
    <div>
            ...
            <div class="flex flex-col lg:flex-row items-center p-5">
                ...
                <div class="lg:ml-2 lg:mr-auto text-center lg:text-left mt-3 lg:mt-0">
                    ...
                    <div class="text-slate-500 text-xs mt-0.5">
                        {{ great_contributor ? (great_contributor === '1' ? 'SI' : 'NO') : 'SIN REGISTRO' }}
                    </div>
                </div>
        ...
        <jet-dialog-modal :show="isOpen" @close="closeModal" max-width=lg>
            <template #title>
                Actualizar Estado Contribuyente
            </template>
    ...
    data() {
        return {
            form: {
                ...
                great_contributor: this.great_contributor,
                justify: ''
            },
            isOpen: false,
            types: []
    ...
    methods: {
        ...
        update(form) {
            ...
            if (!this.v$.form.$invalid){
                ...
                axios.post(route('customer.update-information.great-contributor'), form).then(resp => {
                    this.closeModal()
                    this.$emit('success', {
                    ...
                    this.$swal({
                        icon: 'success',
                        title: '¡Éxito!',
                        text: 'Estado contribuyente actualizado con éxito.',
        ...
        trash(){
            this.$swal({
                title: '¿Eliminar registro de gran contribuyente?',
                ...
                allowEscapeKey: false,
                    ...
                    axios.post(route('customer.update-information.great-contributor'), {
                        customer_code: this.customer_code,
                        great_contributor: '',
                        ...
                        this.closeModal()
                        this.$emit('success', {
                            property: 'GRAN_CONTRIBUYENTE', value: ''
                        })

                        this.$swal({
                            icon: 'success',
                            title: '¡Éxito!',
                            text: 'Registro de gran contribuyente eliminado con éxito.',
                            confirmButtonText: 'Aceptar',
                            timerProgressBar: true,
                            timer: 6000
                        });
