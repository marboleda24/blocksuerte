...
<main class="box">
    ...
    <p style="text-align: justify">
        ...
        <strong>{{ $employee_info->nombres_apellidos }}</strong>, {{ $employee_info->sexo === 'M' ? 'identificado' : 'identificada' }}
        con cédula de ciudadanía
        No {{ $employee_info->nit }}; Labora en esta empresa desde
        el {{ format_date(\Carbon\Carbon::parse($contract->fecha_ingreso)) }}, mediante contrato a
        termino {{ $contract->TIPO_CONTRATO }}.
    </p>
